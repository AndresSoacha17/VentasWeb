<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditCliente.aspx.cs" Inherits="VentasWeb.EditCliente" %>
...
<html>
<head>
    <title>| Sistema Admin | Clientes|</title>
          ...
          <tr>
              ...
              <td>
                  <asp:TextBox runat="server" ID="txtNombre"></asp:TextBox>
                   <ASP:RequiredFieldValidator id="rfvValidarNombre" runat="server" errormessage="El Nombre es obligatorio" width="132px" controltovalidate="txtNombre" display="Dynamic"></ASP:RequiredFieldValidator></td>
              </td>
