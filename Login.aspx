<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="VentasWeb.Login" %>
...
<tr>
            ...
            <form id="Form1" runat="server">
                      ...
                      <table width="100%" border="0" cellpadding="0" cellspacing="1">
                        <tr>
                          <td width="135" height="25" align="right" valign="middle">&nbsp;</td>
                          <td width="4" height="25" valign="middle">&nbsp;</td>
                          <td height="25" colspan="2" align="left" valign="bottom"><ASP:Label id="lblGeneralError" runat="server" forecolor="Red" visible="False"></ASP:Label></td>
                        </tr>
                ...
                <td width="202" height="20" align="left" valign="middle">
                          <ASP:RequiredFieldValidator id="chkPassword" runat="server" errormessage="Must enter a Password" controltovalidate="txtPassword" display="Dynamic"></ASP:RequiredFieldValidator></td>
                        </tr>
